...
class Verifier:
    ...
    def verify_outputs(self, input_rows: List[LeadRow], final_output: List[LeadRow], rejected_output: List[LeadRow]):
        ...
        self.logger.log_event("PHASE_3", "VERIFICATION_SUCCESS", reason="All checks passed")
