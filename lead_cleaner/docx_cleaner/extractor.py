...
class ContentBlock:
    ...
    def __init__(
        self, block_type: str, content: str, index: int, metadata: Dict[str, Any] = None
    ):
        ...
        for section in self.document.sections:
            if section.header:
                for para in section.header.paragraphs:
                    ...
                    if text:
                        self.blocks.append(
                            ContentBlock(block_type="header", content=text, index=index)
                        )
                        index += 1
            ...
            if section.footer:
                for para in section.footer.paragraphs:
                    ...
                    if text:
                        self.blocks.append(
                            ContentBlock(block_type="footer", content=text, index=index)
                        )
                        index += 1
